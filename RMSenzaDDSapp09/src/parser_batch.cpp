...
void print_summary() {
  ...
  for (const auto &sim : global_sim_records) {
...
int main(int argc, char *argv[]) {
  ...
  while (std::getline(*input_stream, line)) {
    ...
    // Parsing token-based pipe fields natively
  ...
  // Una volta processato tutto e salvato nei vettori, stampiamo MASSIVAMENTE
  // ORA (Batch/Offline Pattern)
  print_summary();
