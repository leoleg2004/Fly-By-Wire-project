...
int main(int argc, char *argv[]) {
  ...
  // Affinità Core (Tutti i thread sul CORE 0 per competere per il tempo macchina)
  CPU_ZERO(&cpuset1);
  CPU_SET(0, &cpuset1);
  ...
  // ==========================================
  // -- THREAD 1 -- "Ciao" (Meno prioritario)
  // ==========================================
  t_activity_par activity_1;
  sprintf(activity_1.name, "Ciao");
  ...
  pthread_setname_np(thread1, "Ciao");

  // ==========================================
  // -- THREAD 2 -- "altitudine" (Più prioritario)
  // ==========================================
  t_activity_par activity_2;
  sprintf(activity_2.name, "altitudine");
  ...
  pthread_setname_np(thread2, "altitudine");

  // ==========================================
  // -- THREAD 3 -- "rollio" (Priorità intermedia)
  // ==========================================
  t_activity_par activity_3;
  sprintf(activity_3.name, "rollio");
  activity_3.function = ActivityIncrement;
  activity_3.period = 500;  // Periodo intermedio per il RM
  activity_3.parameter = 3;
  ...
  pthread_setname_np(thread3, "rollio");
