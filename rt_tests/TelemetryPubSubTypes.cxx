...
SystemStatsPubSubType::SystemStatsPubSubType()
{
    ...
    uint32_t type_size = SystemStats_max_cdr_typesize;
...
{
    const ::SystemStats* p_type =
            static_cast<const ::SystemStats*>(data);
...
uint32_t SystemStatsPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void SystemStatsPubSubType::register_type_object_representation()
{
    register_SystemStats_type_identifier(type_identifiers_);
}
